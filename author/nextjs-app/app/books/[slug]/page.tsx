  ...
  return (
    <div className="container mx-auto py-12 lg:py-24 bg-white">
      <article className="max-w-4xl mx-auto">
        {/* Header section with cover and details side by side */}
        <div className="grid md:grid-cols-[280px_1fr] gap-8 lg:gap-12">
          {/* Cover Image */}
          {book.coverImage?.asset?.url && (
            <div className="relative aspect-[3/4] rounded-lg overflow-hidden shadow-lg bg-cream-100">
              <CoverImage
          ...
          <div className="flex flex-col">
            ...
            {/* Book excerpt/tagline */}
            {book.excerpt && (
              <blockquote className="italic border-l-4 border-gold-400 pl-4 text-brown-700 text-lg">
                {book.excerpt}
              </blockquote>
            )}
          </div>
        ...
        {/* Description section */}
        {book.description && (
          <div className="mt-12 prose lg:prose-lg max-w-none">
